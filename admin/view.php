...
<body>
    ...
    <header>
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top"style="background-color:#ffba00">
            <a class="navbar-brand" href="#">karma Ecom Admin</a>
        ...
        <table class="table" border="1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $item['prix'];?>.DH</td>
                    <td class="d-flex justify-content-center mt-2"><img class="imgstyle" src="../img/product/<?= $item['image_item'];?>" alt=""> </td>
                </tr>
                <?php endforeach;?>
            </tbody>
        </table>
